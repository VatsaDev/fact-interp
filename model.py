...
class CausalSelfAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        # manual implementation of attention, for att map
...
class GPT(nn.Module):
    ...
    def estimate_mfu(self, fwdbwd_per_iter, dt):
        """ estimate model flops utilization (MFU) in units of T4 float16 peak FLOPS """
        ...
        # express our flops throughput as ratio of T4 float16 peak flops
        flops_achieved = flops_per_iter * (1.0/dt) # per second
        flops_promised = 65e12 # T4 GPU float16 peak flops is 65 TFLOPS
        mfu = flops_achieved / flops_promised
        return mfu

    @torch.no_grad()
    def generate(self, idx, probs_display, max_new_tokens, temperature=1.0, top_k=None):
        """
